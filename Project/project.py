...
ws.write(row,3,"artist")
ws.write(row,4,"album")
...
for song in songs["data"]:
	...
	ws.write(row,3,song["artist"]["name"])
	ws.write(row,4,song["album"]["title"])
